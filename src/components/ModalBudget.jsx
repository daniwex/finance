...
export default function ModalBudget({ closeBtn }) {
  return (
      ...
      <div className="bg-white h-fit w-fit px-7 py-4">
        ...
        <form className="mt-5">
          <div className="text-xs mb-5">
            ...
            <select className="w-full mt-3 border py-3 px-3">
          ...
          <div className="text-xs mb-5">
            ...
            <input placeholder="e.g. 2000" className="border px-3 mt-3 py-3 w-full"  />
          </div>
          <div className="text-xs mb-5">
            <label className="block">Theme</label>
            <select className="w-full mt-3 border py-3 px-3">
              <option value="green"><span></span>Green</option>
              <option value="bills">Bills</option>
              <option value="groceries">Groceries</option>
              <option value="dining">Dining Out</option>
              <option value="transportation">Transportation</option>
          ...
          <input className="w-full text-xs text-white bg-grey_500 py-3 rounded-lg" type="submit" value="Add budget" />
        </form>
      </div>
    </div>
  );
